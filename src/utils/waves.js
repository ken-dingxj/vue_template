(function() {
  ...
  window.Waves = function Waves(holder, options) {
    var Waves = this;
  ...
  Waves.prototype.animate = function() {
    ...
    window.animateID = requestAnimationFrame(Waves.animate.bind(Waves));
  };

  Waves.prototype.cancelAnimate = function() {
...
// var waves = new window.Waves('#holder', {
//   fps: true,
//   waves: 3,
//   width: 200
// });
